...
При каждой установке autoXRAY генерирует новые UUID и пароли для защиты пользователей, а также выбирает случайные SNI из списка для маскировки.
...
Запустите скрипт заново - он сформирует новые конфигурации VPN для ютуба, чатГПТ и других нужных сайтов.
