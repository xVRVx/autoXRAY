...
Будем использовать маскировку под собственный сайт (selfsteal), который крутится на вашем же VPS. Вам нужно получить это платный/бесплатный поддомен для сайта и VPS.
