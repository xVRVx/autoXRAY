...
Рекомендуемая система: чистая Ubuntu 24. Также поддерживаются Debian 12.
...
Для установки надо [купить домен](#покупаем-домен) и [арендовать VPS](#выбор-сервера-подбирал-промо-тарифы) с ДНС-хостингом.
