...
<body><h3>🚀 VLESS RAW Reality Vision</h3><div class="box">$link1<a href="$link1">📋 Нажмите,чтобы скопировать/добавить</a></div><h3>🛸 VLESS XHTTP Reality</h3><div class="box">$link2<a href="$link2">📋 Нажмите,чтобы скопировать/добавить</a></div><h3>🛡️ Shadowsocks</h3><div class="box">$link3<a href="$link3">📋 Нажмите,чтобы скопировать/добавить</a></div><h3>📂 Ссылка на подписку (готовый конфиг клиента с роутингом)</h3><div class="box"><a href="$subPageLink" target="_blank">$subPageLink</a></div><h3>📱 Приложение HAPP (Windows/Android/iOS/MAC/Linux)</h3>
<p>Маршрутизацию нужно выключить, она тут встроенная</p><div class="btn-group"><a href="happ://add/$subPageLink" class="btn">⚡ Автодобавление в HAPP</a><a href="https://www.happ.su/main/ru" target="_blank" class="btn download">⬇️ Скачать HAPP</a></div></body></html>
EOF
